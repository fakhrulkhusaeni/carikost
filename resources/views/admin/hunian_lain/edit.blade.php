            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 sm:p-8 max-w-5xl mx-auto grid grid-cols-1 gap-6">
                ...
                <form method="POST" action="{{ route('admin.hunian_lain.update', $hunianLain->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="telepon" class="block mt-1 w-full" inputmode="numeric" type="text" name="telepon" :value="old('telepon', $hunianLain->telepon)" required 
                            maxlength="13"
