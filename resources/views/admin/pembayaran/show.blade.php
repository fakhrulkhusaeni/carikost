            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <span class="text-gray-600">{{ $pembayaran->nominal}}</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="bg-red-100 text-red-700 border border-red-300 rounded-md p-3 mt-2">
                            ...
                            <p class="mt-1">{{ $pembayaran->catatan_penolakan }}</p>
                        </div>
                        @endif
                ...
                <!-- Bukti Identitas (full-width kolom) -->
                <div class="md:col-span-2">
                    <span class="font-semibold text-gray-700">Bukti Identitas: </span><br>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-4 mt-6">
                    ...
                    <div class="w-full sm:w-auto">
                        ...
                        <!-- Modal Penolakan -->
                        <div id="modalTolak{{ $pembayaran->id }}" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                            <div class="bg-white p-6 rounded-lg w-full max-w-md">
                                ...
                                <form action="{{ route('admin.pembayaran.reject', $pembayaran->id) }}" method="POST">
                                    @csrf
                                    <textarea name="catatan_penolakan" class="w-full border border-gray-300 rounded p-2 mb-4" rows="4" placeholder="Masukkan alasan penolakan..." required></textarea>
                                    <div class="flex justify-end space-x-2">
                                        <button type="button" onclick="document.getElementById('modalTolak{{ $pembayaran->id }}').classList.add('hidden')" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Batal</button>
