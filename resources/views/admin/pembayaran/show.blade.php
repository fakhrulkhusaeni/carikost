            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center mb-6">
                    ...
                    <div class="text-start">
                        ...
                        <span class="text-gray-500">Pencari Hunian</span>
                    </div>
                </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="mb-4">
                        ...
                        <span class="text-gray-600">{{ $pembayaran->user->email }}</span>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <span class="font-semibold text-gray-700">Kartu Identitas: </span>
                        <br>
